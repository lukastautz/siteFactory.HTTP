...
#include <fcntl.h>
#include <arpa/inet.h>
#define VERSION                   "siteFactory HTTP server v5.6 compiled with bash CGI support"
...
#define CGI_EXT                   "sh"                 // Sets the extension of the recognized CGI files
#define CGI_BINARY                "/bin/bash"          // Sets the CGI interpreter
#define CGI_NAME                  "bash"               // Sets the name of the CGI interpreter (mostly the name of the binary file)
/*
 Important note:
  - You can access the REQUEST_URI with $1, and the query string with $2
